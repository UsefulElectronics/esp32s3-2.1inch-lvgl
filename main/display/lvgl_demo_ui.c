...
static void ui_lamp_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_Panel9, &ui_img_bg1_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_Switch1 = lv_switch_create(ui_Panel10);
